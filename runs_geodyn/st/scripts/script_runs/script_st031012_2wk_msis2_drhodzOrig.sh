...
ARC_name=st031012_2wk 
ARC=${1:-${ARC_name}}

FTN05DIR=/data/geodyn_proj/runs_geodyn/st/setups/${SETUP_DEN_DIR}_${ACCELS}
INPUTDIR=$FTN05DIR

SERIES=${DEN_DIR}_${ACCELS}${SpecialRun_name}
G2SDIR=/data/geodyn_proj/geodyn_code/IIS/ORIG
G2EDIR=/data/geodyn_proj/geodyn_code/IIE/MODS${GDYN_version}
EMATUDIR=/data/data_geodyn/extra_dirs/           
COMMONDIR=/data/data_geodyn/extra_dirs/                  
COMMONHD4DIR=/data/data_geodyn/extra_dirs/               
DIRGRAV=/data/data_geodyn/inputs/$SATELLITE/gravity                       
DELDIR=/data/data_geodyn/extra_dirs/deletes/$SATELLITE                 
G2BDIR=/data/data_geodyn/inputs/$SATELLITE/g2b                   
ATGRAVDIR=/data/data_geodyn/inputs/$SATELLITE/atgrav             
EPHEMDIR=/data/data_geodyn/inputs/$SATELLITE/ephem
OUTPUTDIR=/data/data_geodyn/results/$SATELLITE/${DEN_DIR}/${SERIES}                   
mkdir /data/data_geodyn/results/$SATELLITE/${DEN_DIR}
mkdir $OUTPUTDIR
mkdir /data/data_geodyn/extra_dirs
BINDIR=/data/data_geodyn/extra_dirs/bin
...
mkdir /data/data_geodyn/extra_dirs/tmp/
mkdir /data/data_geodyn/extra_dirs/tmp/$SATELLITE
TMPDIR=/data/data_geodyn/extra_dirs/tmp/$SATELLITE/$SERIES 
mkdir $TMPDIR
#echo $TMPDIR
#echo $PWD
...
ln -s ${EPHEMDIR}/ephem1421.data ftn01
fi
