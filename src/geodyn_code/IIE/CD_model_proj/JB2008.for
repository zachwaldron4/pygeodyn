...
C           ALN(1) : Natural Log Number Density [N2] (ln(molecules/m**3))
C           ALN(2) : Natural Log Number Density [O2] (ln(molecules/m**3))
C           ALN(3) : Natural Log Number Density [O]  (ln(molecules/m**3))
C           ALN(4) : Natural Log Number Density [Ar] (ln(molecules/m**3))
C           ALN(5) : Natural Log Number Density [He] (ln(molecules/m**3))
C           ALN(6) : Natural Log Number Density [H]  (ln(molecules/m**3))
C
