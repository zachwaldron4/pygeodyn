!$MSIS00
      SUBROUTINE MSIS00(DAY,IYR,ALTM,PHI,XLAMB,COSHL,SINHL,FLUX,AVGFLX,   &
...
!
!
!  PRINTOUT  BEFORE CALL TO MSIS subs FOR TESTING.
...
!
!
! -------------PRINT THE MSIS SWI OPTIONS-------------
!       WRITE(103,7003)  SWI(9)
! 7003   FORMAT((F15.8,1X) )

!
!! -------------PRINT THE SUBROUTINE OUTPUTS-------------
