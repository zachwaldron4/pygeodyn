...
|NOTES REGARDING THE GEODYN/PYGEODYN INTERFACE
|=============================================================================
|                          By Zach Waldron --- April 2022
|-----------------------------------------------------------------------------
|    1) Comments have been added where this code has been modified to
|         to accomodate interfacing to the GEODYN/Pygeodyn program 
|         (most commonly to remove various printing).
...
###     GEODYN EDIT
###  ------------------------------------------------------------
###     Import specific modules and functions
###  ------------------------------------------------------------
###     For functionality reasons we did not install kamodo to 
###      the entire AWS where GEODYN is hosted.  Instead we import
###      it as needed.
###  ------------------------------------------------------------
import sys
# flythrough/SatelliteFlythrough.py
sys.path.insert(0,'/data/SatDragModelValidation/src/kamodo_interface/Kamodo_vJan2023/kamodo_ccmc/flythrough')
sys.path.insert(0,'/data/SatDragModelValidation/src/kamodo_interface/Kamodo_vJan2023/')
sys.path.insert(0,'/data/SatDragModelValidation/src/kamodo_interface/Kamodo_vJan2023/kamodo_ccmc/')
### ==========================================================================
...
def ModelFlythrough(model, file_dir, variable_list, sat_time, c1, c2, c3, 
                    coord_type, coord_grid, high_res=20., verbose=True, 
    ...
    #### ZACH EDIT
#     print('SatelliteFlythrough/ModelFlythrough(): ',coord_type,coord_grid)
...
### GEODYN EDIT: Removed unused portions of code for the GEODYN case
#     if verbose: 
