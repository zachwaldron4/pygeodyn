...
def define_4d_interpolator(units, variable, t, lon, lat, ht):
    ...
    # print('ZACH-- define_4d_interpolator')
    # print('ZACH-- ht', ht)
...
def define_4d_gridded_interpolator(units, variable, t, lon, lat, ht,
    ...
    # print('ZACH-- define_4d_gridded_interpolator')
...
def regdef_4D_interpolators(kamodo_object, units, variable, t, lon, lat, z,
    ...
    Output: The same kamodo object given, except with the new function(s) included.
    '''
    # print('ZACH-- regdef_4D_interpolators')
    # print(f"      varname {varname}")
    # if varname[0:3] == "rho" or varname[0:2] == "N_":
    #     interpolator = define_4d_interpolator(units, np_log(variable), t, lon, lat, z)
    #     kamodo_object = register_interpolator(kamodo_object, varname, np_exp(interpolator),
    #                                         xvec_dependencies)
...
# 'np.exp(np.interp(hi, h ,np.log(x)))'
    ...
    if gridded_int:
        kamodo_object.variables[varname+'_ijk'] = dict(units=units, data=variable)
        gridded_interpolator = define_4d_gridded_interpolator(units, variable, t,
                                                              lon, lat, z,
                                                              xvec_dependencies,
                                                              interpolator)
        kamodo_object = register_interpolator(kamodo_object, varname+'_ijk',
