...
#                 self.model_data_path ='/data/data_geodyn/atmos_models_data/tiegcm/2018/Lutz_Rastaetter_072319_IT_1' 
                ...
                filemodels = open("/data/geodyn_proj/pygeodyn/pygeodyn_GetStarted/geodyn_modelpaths.txt","w+")
    ...
    def geodyn_modify_inputs(self, options_in, density_model):
        ...
        file1 = open("/data/geodyn_proj/pygeodyn/pygeodyn_GetStarted/geodyn_options.txt","w+")
...
# import pandas as pd
# import sys
# sys.path.insert(0,'/data/geodyn_proj/pygeodyn/pygeodyn_GetStarted/util_dir/')
