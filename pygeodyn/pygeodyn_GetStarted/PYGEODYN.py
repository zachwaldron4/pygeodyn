...
sys.path.insert(0,'/data/geodyn_proj/pygeodyn/pygeodyn_GetStarted/util_preprocessing/')
...
# satellite_icesat2 contains pygeodyn_controller and pygeodyn_reader. run_pygeodyn function is in the pygeodyn_controller
...
# transfering all the parameters (run_params) from the YAML file to the Pygeodyn class
...
#             print(i,val, self.run_settings[val])
            if val in  ['run_params', 'model_data_path','request_data','cards_to_remove',
                ...
                if self.run_settings[val] == self.__dict__[val]: # __dict__ contains the object's attributes
                    pass
#                     print('fine')
                else:
#                     print(val)
