...
#     end1 = time.time()
#     elapsed1 = end1 - start
#     print('AdjustedParams 1: ',elapsed1)
# # ------------------------------------------------------------
# # ------------------------------------------------------------
...
#     end1 = time.time()
#     elapsed1 = end1 - start
#     print('AdjustedParams 2: ',elapsed1)
# # ------------------------------------------------------------
# # ------------------------------------------------------------
...
#     end1 = time.time()
#     elapsed1 = end1 - start
#     print('AdjustedParams 3: ',elapsed1)
# # ------------------------------------------------------------
# # ------------------------------------------------------------
...
#     end1 = time.time()
#     elapsed1 = end1 - start
#     print('AdjustedParams 4: ',elapsed1)
# # ------------------------------------------------------------
# # ------------------------------------------------------------
...
#     end1 = time.time()
#     elapsed1 = end1 - start
#     print('AdjustedParams 5: ',elapsed1)
# # ------------------------------------------------------------
# # ------------------------------------------------------------
...
#     end1 = time.time()
#     elapsed1 = end1 - start
#     print('AdjustedParams 6: ',elapsed1)
# # ------------------------------------------------------------
# # ------------------------------------------------------------
...
#     end1 = time.time()
#     elapsed1 = end1 - start
#     print('Density file before time: ',elapsed1)
...
#      I've run into an issue where some arcs have way more iterations that seems correct (such as 11). IN these cases, it seems like the final iteration listed in IIEOUT is the 9th  (last single digit??)
    if int(iteration) >= 10:
        iteration = '9'
...
#      I've run into an issue where some arcs have way more iterations
#     that seems correct (such as 11). IN these cases, it seems like the 
#     final iteration listed in IIEOUT is the 9th  (last single digit??)
    if iter_nums >= 10:
        iter_nums = 9
    ...
    elapsed = end - start
    print('residual by station: ',elapsed)
