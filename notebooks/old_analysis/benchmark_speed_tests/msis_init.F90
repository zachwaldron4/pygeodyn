...
!    print *,"IN msis_init: parmpath: ",parmpath
!    print *,"IN msis_init: parmfile: ",parmfile 
!    print *,"IN msis_init: switches: ",switch_legacy
!    print *,"IN msis_init: unit for parm: ",iun
    !INQUIRE(UNIT =67)
!    print *,"IN msis_init: INQUIRE: ", INQUIRE(67)
...
!    print *,"IN msis_init: call loadparmset: ",trim(parmpath1)
!    print *,"IN msis_init: call loadparmset: ",trim(parmfile1)
!    print *,"IN msis_init: call loadparmset: ",iun1
