...
#         print('zach--  height_request',height_request)
#         print('zach--  utc_time',results_dict['utc_time'][i])
#         print('zach--  c1      ',results_dict['c1'][i])
#         print('zach--  c2      ',results_dict['c2'][i])
#         print('zach--  c3      ',results_dict['c3'][i])
#         print('zach--  net_idx ',results_dict['net_idx'][i])
