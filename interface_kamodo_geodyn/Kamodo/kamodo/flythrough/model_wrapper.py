...
#     print('MW   Func: convert_model_string()          ', perf_counter()-t0,'s')
...
#     print('MW   Func: Choose_Model()                  ', perf_counter()-t0,'s')
...
#     print('MW   Func: FileSearch()                    ', perf_counter()-t0,'s')
    
    if isinstance(model,int): model = model_dict[model]  #convert to string
        
#     print('Check-- FileSearch: model',model)
...
#     print('MW   Func: Model_Reader()                  ', perf_counter()-t0,'s')
...
#     print('MW   Func: Model_Variables()               ', perf_counter()-t0,'s')
...
#     print('MW   Func: Var_3D()                        ', perf_counter()-t0,'s')
...
#     print('MW   Func: Var_ilev()                      ', perf_counter()-t0,'s')
...
#     print('MW   Func: Var_units()                     ', perf_counter()-t0,'s')
...
#     print('MW   Func: convert_variablenames()         ', perf_counter()-t0,'s')
...
#     print('MW   Func: convert_coordnames()            ', perf_counter()-t0,'s')
...
#     print('MW   Func: coord_units()                   ', perf_counter()-t0,'s')
...
#     print('MW   Func: coord_names()                   ', perf_counter()-t0,'s')
