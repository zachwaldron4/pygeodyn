...
!    write(6,*) 'CHECK-msis_init.F90:parmfile ' parmfile
!    write(6,*) 'CHECK-msis_init.F90:parmpath ' parmpath
    ...
    print *,"@loadparmset: ",trim(parmpath1)//trim(parmfile1),"   .    "
  ...
  subroutine loadparmset(name,iun)
    ...
    print *,"MSIS parameter set is ",name,". " 
