...
!
      if(ICNT.eq.1)then
          WRITE(6,*) 'CHECK -- Using MODS_msis00 / MSIS.f90'
      endif
...
! 811 FORMAT(1X,'INPUT TO GTD7: Y+S',I8,1X,F10.4,1X,'ALTkm: ',F12.3,1X,&
...
!      
!          write(6,'(9a7,9a13,a8)') &
!            'IYYDDD','UTSEC','ALTKM','GLAT','GLON','STLOC','AVGFLX',    &
!             & 'FLUX','AP', 'MASS','D','T' 
!
!          write(6,'(9a7,9a13,a8)') &
!            kind(IYYDDD),'UTSEC','ALTKM','GLAT','GLON','STLOC','AVGFLX',    &
!             & 'FLUX','AP', 'MASS','D','T'
      endif
!!!!!!!!!###################################################################################
!                               CALL MSIS
!
      CALL GTD7(IYYDDD,UTSEC,ALTKM,GLAT,GLON,STLOC,AVGFLX,FLUX,AP,      &
     &          48,DEN,TEMP)
!
!!!!!!!!!###################################################################################
!
...
!*  PRINTOUT FOR TESTING.
!     PRINT 812,DEN
! 812 FORMAT(1X,'OUTPUT of GTD7: ',/,                         &
!            1X, 'DEN: ',9(E15.8,1X) )
!            1X,'RHO: ',E15.8,1X,                             &
!            1X,'TEMP_exo: ',E15.8,1X,                        &
!            1X,'TEMP_alt: ',E15.8,1X )
