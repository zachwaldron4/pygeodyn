!$
      SUBROUTINE GPSNIL(COSEL,SINEL,EDOT,RNM,CDRY,CWET,CION,NM,         &
     &   MODELT,LNDRYT,LNWETT,LNIONO,BLKMET,OBSMET,LOBMET,LALTON,       &
     &   RLATA,COSLTA,SINLTA,HTA,MTYPE,MJDSBL,FSEC,IWPR,NSTA0)
!********1*********2*********3*********4*********5*********6*********7**
! GPSNIL           00/00/00            0000.0    PGMR - ?
!
!
! FUNCTION:  TROP REFRACTION CORRECTION USING GPS MODEL AND NIELL MF
!
! I/O PARAMETERS:
!
...
!           WRITE(400,'(I8,1x,G24.16,1X,E9.3,1x,E9.3)') NSTA0,STRTIM, &
!         & CDRY(N),CWET(N)
