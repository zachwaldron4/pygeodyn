!$TRKMAG
      SUBROUTINE TRKMAG(XSM,VSM,UI,OFFSET,FSECRA,RA,DR,AA,II,ISATID,    &
     &                  LALT,NDIMRA,ATROT,LANTCT,IANTSC,DWRKDO,LOFFAJ)
!********1*********2*********3*********4*********5*********6*********7**
! TRKMAG           95/07/14            9505.0    PGMR - J. McCarthy
!
!
! FUNCTION:  COMPUTE CORRECTIONS TO RANGE DUE TO LOCATION OF
!            TRACKING POINT AND S/C C.G. NOT AT BODY-FIXED
!            ORIGIN FOR MAGNETICALLY STABILIZED SATELLITE
!
! I/O PARAMETERS:
!
...
60001 FORMAT(' TRKMAG CALLED FOR GPS MEASUREMENTS:')
