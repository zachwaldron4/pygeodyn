!$PSUMNM
      SUBROUTINE PSUMNM(ICON  ,DXSDPM,COSTHG,SINTHG,PMPXI ,XM    ,      &
     &    PXSPXP,PXSPLV,NMP   ,NADJP ,NM    ,NINTPL,                    &
     &    PMPXE ,PMPA  ,ISTA  ,LESTA ,LESTP ,ISTAMT,PXSPAB)
!********1*********2*********3*********4*********5*********6*********7**
! PSUMNM           00/00/00            0000.0    PGMR - ?
!
!
! FUNCTION:
!
...
!***********************************************************************
!
!     PRINT 12345,NM,ISTA,LESTA,LESTP
!2345 FORMAT(' ** PSUMNM **  NM,ISTA,LESTA,LESTP='/(1X,4I12))
...
!2346 FORMAT(' ** PSUMNM **  IXH2LV,IXL2LV=',2I12/' NPVAL0='/(1X,5I12))
      IXLOVE=IXH2LV
      DO 9000 J=1,2
