!$XETRPY
      SUBROUTINE XETRPY(AA,II,MJDSIN,FSECIN,IATSAT,KVLAS,ATIME,         &
     &                  ISEQ,ISATID,IITERP,ATROT3,ATPER,ISET1,ROLL,     &
     &                  PITCH,YAW,TDIF,SINWT,COSWT,LCALLF,LMB,XSAT,VSAT)
!*******************************************************************
!  ROUTINE NAME:   XETRPY   DATE: 04/27/98      PGMR: D. E. PAVLIS
!
...
!
!               THIS IS A MODIFIED VERSION OF GETRPY WHERE ATITUDE
!               TIME PERIODS ARE RECKONED BY ORBIT ANGLE
!
!
!  I/O PARAMETERS:
!
...
!
! THE FOLLOWING IS AN ORBIT ANGLE APPROACH TO ATTITUDE TIME PERIODS
!
      IMID=(JNM/2)+1
...
! IN THIS CASE THERE IS ONLY THE SC BODY
 ...
 1510  CONTINUE
      ...
      CALL MATPRD(ATROT1,ATROT2,ATROT3(1,1,INMNDX),3,3,3)
 ...
 3000 CONTINUE
      RETURN
6000  FORMAT(' EXCUTION TERMINATING IN SUBROUTINE XETRPY')
...
6008  FORMAT(' NOT AVAILABLE OR THIS SATELLITE ')
      END
