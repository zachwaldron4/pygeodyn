!$CHBMTX
      SUBROUTINE CHBMTX(SCHB1,SCHB2,SCHBV1,SCHBV2,SCR1,ICB,ISUPE)
!********1*********2*********3*********4*********5*********6*********7**
...
! ASSUME EARTH TRACKING BODY
       IF(ICBDGM.GT.11) THEN
      IORCB=ISUPE((ICBDGM-11),2)/3
       ELSE
      IORCB = ICHBOG(1,14)
       ENDIF
      IORTB = IOREM
