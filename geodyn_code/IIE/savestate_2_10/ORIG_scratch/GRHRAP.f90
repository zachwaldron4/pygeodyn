!$GRHRAP
      SUBROUTINE GRHRAP(MJDSEC,FSEC,LEQC,LONLEQ,EQN,SCRTCH,THETAG,      &
...
! GET EQN OF EQUINOX
     ...
     &            NM,SCRTCH)
!     WRITE(6,*) '  GRHRAP :  CALL NPVECT MJDSEC,FSEC  ',MJDSEC,FSEC
...
! GET GREENWICH HOUR ANGLE
  500 CONTINUE
      CALL GRHRNP(MJDSEC,FSEC,EQN,SCRTCH,THETAG,COSTHG,                 &
     &           SINTHG,NM,AA,UTDT)
      RETURN
      END
