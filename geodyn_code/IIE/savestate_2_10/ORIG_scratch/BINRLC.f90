!$BINRLC
      SUBROUTINE BINRLC(IUNT,IARRAY,ISIZE)
! *******1*********2*********3*********4*********5*********6*********7**
! BINRLC           00/00/00            0000.0    PGMR - B. EDDY
!                                                PGMR - SBL
!
...
!**********************************************************************
   ...
   17 FORMAT(BZ,I25)
      RETURN
  100 CONTINUE
      CALL FRMRDL(IUNT,IARRAY,ISIZE-1)
      READ(IUNT,17) IARRAY(ISIZE)
      RETURN
      ELSE
