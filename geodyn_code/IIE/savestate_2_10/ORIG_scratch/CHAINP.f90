!$CHAINP
      SUBROUTINE CHAINP(PMPX,NM,I3,IPV,PXPF,NEQN,N3,IND,IL,NPVECT,PMPF)
!********1*********2*********3*********4*********5*********6*********7**
! CHAINP           82/08/27            8208.0    PGMR - TOM MARTIN
!
...
! SAT PER CALL(I3=3)
      ...
      INDS=IND(IPVECT)-1
      ILS=IL(IPVECT)
! THRU 2000 LOOPS OVER FORCE MODEL PARAMEPERS WITHIN SUBSETS
