!$NCHAIN
      SUBROUTINE NCHAIN(PMPX,NM,I3,IPV,PXPF,NEQN,N3,IND,IL,NPVECT,PMPF)
!********1*********2*********3*********4*********5*********6*********7**
! NCHAIN           82/08/27            8208.0    PGMR - TOM MARTIN
!
...
!2345 FORMAT(' ** NCHAIN **  NM,I3,IPV,NEQN,N3,NPVECT='/(1X,6I11))
!     PRINT 12346,IND
!2346 FORMAT(' ** NCHAIN **  IND='/(1X,5I12))
!     PRINT 12347,IL
!2347 FORMAT(' ** NCHAIN **  IL='/(1X,5I12))
!     PRINT 12348,PMPX
!2348 FORMAT(' ** NCHAIN **  PMPX='/(1X,5G15.8))
!     PRINT 12349,PXPF
!2349 FORMAT(' ** NCHAIN **  PXPF='/(1X,5G15.8))
!***** END DEBUG *****
...
!***** DEBUG *****
!     PRINT 22345,PMPF
!2345 FORMAT(' ** NCHAIN **  PMPF='/(1X,5G15.8))
!***** END DEBUG *****
      RETURN
      END
