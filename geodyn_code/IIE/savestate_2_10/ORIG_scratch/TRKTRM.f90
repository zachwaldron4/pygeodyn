!$TRKTRM
      SUBROUTINE TRKTRM(XSM,VSM,UI,OFFSET,FSECRA,RA,DR,AA,II,ISATID,    &
     &                  LANTCT,IANTSC,NDIM,DWRKDO,LOFFAJ)
!********1*********2*********3*********4*********5*********6*********7**
...
60001 FORMAT(' TRKTRM CALLED FOR GPS MEASUREMENTS:')
