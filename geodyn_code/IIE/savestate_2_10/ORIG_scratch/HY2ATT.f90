!$HY2ATT
      SUBROUTINE HY2ATT(MJDS,FSEC,XSAT,VSAT,BFNRM1,BFNRM2,BFNRM3,       &
...
!*******************************************************************
!  ROUTINE NAME:   HY2ATT   DATE: 08/23/12      PGMR: D. PAVLIS
!
!   FUNCTION - TO COMPUTE ROTATION FROM HY-2A BODY-FIXED FRAME TO THE
!              GEODYN TRUE OF REFERENCE FRAME, BASED ON THE HY-2A
...
!
!************ HY-2A LOCAL VARIABLE DEFFINITIONS************************
...
!             X = ALONG VELOCITY,NEGATIVE IN DIRECTION OF VELOCITY
!             Y = ALONG SA AXIS, NEVATIVE IN DIRECTION OF SA
...
! ROTATE BODY-FIXED LOUVER ACCELERATION VECTOR IF NECESSARY
 ...
 1000 CONTINUE
!
! OUTPUT HY-2A TELEM FILE INFORMATION
