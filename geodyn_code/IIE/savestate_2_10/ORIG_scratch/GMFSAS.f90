...
!$
      SUBROUTINE GMFSAS(COSEL,SINEL,EDOT,RNM,CDRY,CWET,CION,NM,         &
     &   MODELT,LNDRYT,LNWETT,LNIONO,BLKMET,OBSMET,LOBMET,LALTON,       &
     &   RLATA,COSLTA,SINLTA,HTA,MTYPE,MJDSBL,FSEC,IWPR,NSTA0)
!********1*********2*********3*********4*********5*********6*********7**
! GMFSAS           00/00/00            0000.0    PGMR - ?
!
!
! FUNCTION:  TROP REFRACTION CORRECTION USING GMF/SAASTAMOINEN MODEL
!
! I/O PARAMETERS:
!
