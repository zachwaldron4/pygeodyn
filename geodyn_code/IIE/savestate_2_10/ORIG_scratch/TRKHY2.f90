!$TRKHY2
      SUBROUTINE TRKHY2(XSM,VSM,UI,OFFSET,FSECRA,RA,DR,AA,II,LALT,      &
     &                  NDIMRA,ATROT,LANTCT,IANTSC,ISATID,STAINF,       &
     &                  INDSTA,PHC,ANTTAB,LDORANT,DWRKDO,LOFFAJ)
!********1*********2*********3*********4*********5*********6*********7**
! TRKHY2            03/01/13            1212.1 PGMR - DESPINA. E. PAVLIS
!
!
...
!   LANTCT   I    A    LOGICALL ANTENA CUTOFF
...
!
!
        CALL HY2ATT(MJDSEC,FSEC,XPOS,VPOS,BDFOFF(1),BDFOFF(2),BDFOFF(3),&
...
60001 FORMAT(' TRKH2A CALLED FOR GPS MEASUREMENTS:')
