...
!!!!!!! NORM2 dOES NOT EXIST; NEED TO CHECK OUT WHAT IT SHOULD DO!!!!!
!!!      VMERC_NORM=NORM2(VMERC)
!!!      VSAT_NORM=NORM2(VSAT)
!!! GUESS AY NORM2
         VMERC_NORM=VMERC(1)*VMERC(1)+VMERC(2)*VMERC(2)+VMERC(3)*VMERC(3)
         VSAT_NORM=VSAT(1)*VSAT(1)+VSAT(2)*VSAT(2)+VSAT(3)*VSAT(3)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
