!$TRKTDS
      SUBROUTINE TRKTDS(XSM,VSM,UI,OFFSET,FSECRA,RA,DR,AA,II,LALT,      &
     &NDIMRA,ATROT,LANTCT,IANTSC,ISATID,DWRKDO,LOFFAJ)
!********1*********2*********3*********4*********5*********6*********7**
! TRKTDS            94/03/30            9212.4    PGMR - SCOTT B. LUTHCK
!
!
...
!
!
        CALL TDRSAT(MJDSEC,FSEC,XPOS,VPOS,BDFOFF(1),BDFOFF(2),          &
...
60001 FORMAT(' TRKTDS CALLED FOR GPS MEASUREMENTS:')
