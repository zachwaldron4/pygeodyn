!$CHBMAT
      SUBROUTINE CHBMAT(SCHB1,SCHB2,SCHBV1,SCHBV2,SCR1)
!********1*********2*********3*********4*********5*********6*********7**
! CHBMAT           88/11/17            8901.0    PGMR - A. MARSHALL
!
...
!********1*********2*********3*********4*********5*********6*********7**
      ...
      SAVE
       DOUBLE PRECISION ZERO,ONE,TWO,FNSEC,DELTT
       DOUBLE PRECISION SCHB1,SCHB2,SCHBV1,SCHBV2,SCR1
     ...
     &              IPLNZ(999),NXPLNI
!
      DIMENSION CHB1(15),CHB2(15),CHBV1(15),CHBV2(15),CHBVV1(50,15),    &
     &          CHBVV2(50,15),UPT(120),CHEB(200,15),CTC(15,15),         &
     &          TWOT(1),VSEC(4)
      DIMENSION SCHB1(15,50),SCHB2(15,50),SCHBV1(15,50),SCHBV2(15,50),  &
     &          SCR1(200,15,7),FNSEC(4)
      DIMENSION IGRPP(7),IORD(7)
...
! COMPUTE CHEBYCHEV POLYNOMIALS
      ...
      CHBV1(2)= ONED
      CHBV2(2)= ONED
      CALL CHEBDP(CHB1,CHBV1,DT1,15,1,TWOT,.TRUE.)
      CALL CHEBDP(CHB2,CHBV2,DT2,15,1,TWOT,.TRUE.)
!
      DO 100 J=1,15
       SCHB1(J,I)  =CHB1(J)
       SCHB2(J,I)  =CHB2(J)
