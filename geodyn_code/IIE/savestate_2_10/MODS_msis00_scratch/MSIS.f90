!$MSIS
     ...
     &                XKP,INDEX,IKPAP,I324,IDRV,RHO,DRHODZ,IERR,MSIS_FLAG)
!********1*********2*********3*********4*********5*********6*********7**
...
!      INCLUDE 'msis2.0.parm'
      DIMENSION XKP(*)
      DIMENSION AP(7),SWI(25),DEN(8),TEMP(2)
!
...
!
      IF(MSIS_FLAG.EQ.86) THEN 
!          CALL GTS5(IYYDDD,UTSEC,ALTKM,GLAT,GLON,STLOC,AVGFLX,FLUX,AP,      &
!         &          48,DEN,TEMP) 
!
!              WRITE(6,*) 'CHECK -- MSIS.f90: DENSITY MODEL take msis2'
!              WRITE(6,*) 'MSIS.f90: Called msisinit'                
!              WRITE(6,*) 'CHECK -- MSIS.f90: Called msisinit

!              WRITE(6,*) 'CHECK -- MSIS.f90: AP' AP
